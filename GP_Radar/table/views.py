...
class TableFilterParam:
    def __init__(self, page, address, postcode, keyword, pagesize, patient_size="", health_board="", patient_ratio=""):
        self.page = page
...
# Enhanced filtering for Apply Filter button
def get_Practices(request):
    ...
    if patient_size != "":
        ...
        if "-" in patient_size:
            ...
            practices = practices.filter(list_size__gte=min_size, list_size__lte=max_size)
...
def apply_filters_api(request):
    ...
    if request.method == 'GET':
        try:
            ...
            print(f"Filter Parameters - page: {page}, patient_size: {patient_size}, health_board: {health_board}, patient_ratio: {patient_ratio}")
            ...
            for p in practices:
                ...
                female = GPPopulations.objects.get(practice=p.practice_code, sex="Female")
            ...
            return render(request, "table/dashboard.html", {
                "practices": [],
                ...
                "avg_pat_doc_ratio": 0,
                "filter_params": TableFilterParam(
                    page=1, address="", postcode="", keyword="", pagesize=5,
                    patient_size="", health_board="", patient_ratio=""
                ),
                "total_page_num": 0,
                "page_range": [],
                "begin_index": 0,
                ...
                "error_message": f"Error applying filters: {str(e)}" if str(e) else "An unknown error occurred",
            })
